            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php/pembelian/manage" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="date" name="tgl_lunas" class="form-control" value="<?php echo date("Y-m-d");?>" required></div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <table class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="4" align="right">Pembayaran (Minimal Pembayaran 50.000)</td>
                                            <td><input type="text" class="form-control money" name="pembayaran" id="pembayaran" value="0"/></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right">Sisa Hutang</td>
                                            <td><input type="text" class="form-control money" name="sisa_hutang" id="hutang" value="0" readonly="readonly"/></td>
                                        </tr>
                                        <tr>
                                            <td colspan="4" align="right">Kembalian</td>
                                            <td><input type="text" class="form-control money" name="" id="kembali" value="0" readonly="readonly"/></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
