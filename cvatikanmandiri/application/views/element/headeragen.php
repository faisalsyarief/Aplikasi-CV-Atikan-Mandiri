        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                 ...
                 <li>
                    <a href="<?php echo base_url();?>index.php/Home/agen"><i class="fa fa-home"></i> <span class="nav-label">Homepage</span></a>
                </li>

                 <li>
                    <a href="<?php echo base_url();?>index.php/pembelian/bank"><i class="fa fa-money"></i> <span class="nav-label">Payment</span></a>
                </li>
                <li>
                    <a href="index-2.html"><i class="fa fa-th-large"></i> <span class="nav-label">Pembelian</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li ><a href="<?php echo base_url();?>index.php/Pembelian/manageagen">Form Pembelian</a></li>
                        <li ><a href="<?php echo base_url();?>index.php/Pembelian/viewagen">Data Pembelian</a></li>
                    </ul>
                </li>
                
                <li class="<?php echo @$mnuUser;?>"><?php echo anchor('tracking/list_agen/' . $this->session->userdata('userid'), '<i class="fa fa-truck"></i> Pengiriman'); ?>
                </li>
                 <li class="<?php echo @$mnuUser;?>"><?php echo anchor('user/agen/' . $this->session->userdata('userid'), 'User'); ?></li>
            </ul>
